package com.sede.electronica.security.jwt;
...
public class JwtProvider {
    ...
    public String generateToken(Authentication authentication){
        ...
        List<String> roles = primaryUser.getAuthorities().stream().map(GrantedAuthority::getAuthority).collect(Collectors.toList());
